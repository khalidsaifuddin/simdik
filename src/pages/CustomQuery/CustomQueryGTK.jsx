...
class CustomQueryGTK extends Component {
    state = {
        error: null,
        loading: true,
        kategori: [],
    ...
    unduhexcel = () => {
        ...
        if(this.state.custom_query.total > 1000000){
            ...
            this.props.runCustomQueryDatamart({
                ...
                this.$f7.dialog.close()
                this.JSONToCSVConvertor(result.payload.rows, 'Custom Query GTK', true)
    ...
    {
        return (
            <Page name="CustomQueryGTK" hideBarsOnScroll>
                <Navbar sliding={false} onBackClick={this.backClick}>
                    ...
                    <NavTitle sliding>Custom Query GTK</NavTitle>
                </Navbar>
...
export default (connect(mapStateToProps, mapDispatchToProps)(CustomQueryGTK));