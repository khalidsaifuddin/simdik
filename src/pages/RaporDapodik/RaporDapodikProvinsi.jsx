...
class RaporDapodikProvinsi extends Component {
    state = {
        error: null,
        loading: true,
        routeParams: {
    ...
    {
        return (
            <Page name="RaporDapodikProvinsi" hideBarsOnScroll>
                <Navbar sliding={false}>
                {/* <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}> */}
                    <NavLeft >
                        <Link disabled={(this.state.loading ? true : false)} iconIos="f7:chevron_left" iconAurora="f7:chevron_left" iconMd="material:chevron_left" href="/RaporDapodik/">Nasional</Link>
                    </NavLeft>
                    <NavTitle sliding>Rapor Dapodik</NavTitle>
                    <NavTitleLarge>
                        Rapor Dapodik
                    </NavTitleLarge>
                    <Subnavbar>
                    ...
                    <Row noGap>
                        <Col width="100" tabletWidth="50">        
                            <Card className="demo-card-header-pic" style={{minHeight: '150px'}}>
                                ...
                                >
                                    Rapor Dapodik this.state.nama_wilayah
                                </CardHeader>
                                <CardContent
                                    style={{textAlign: 'center'}}
                                    className="skeleton-text skeleton-effect-blink"
                        ...
                        <Col width="100" tabletWidth="100">
                            <BlockTitle style={{marginTop:'8px'}}>Rapor Dapodik per Wilayah</BlockTitle>
                    ...
                    <Col width="100" tabletWidth="50">        
                        <Card className="demo-card-header-pic" style={{minHeight: '150px'}}>
                            <CardHeader
                                ...
                                style={{textAlign: 'center', display: 'block'}}
                            >
                                Rapor Dapodik {this.props.wilayah.rows[0].nama}
                            </CardHeader>
                            <CardContent
                                style={{textAlign: 'center'}}
                            >
                            ...
                            return (
                                <Row key={option.kode_wilayah} style={{borderBottom:'1px solid #ccc', marginTop:'2px', border:'1px solid #ccc', padding:'8px', borderRadius: '4px'}}>
                                    <Col width="60" tabletWidth="30">
                                        <a href={"/"+(parseInt(option.id_level_wilayah) === 1 ? "RaporDapodikProvinsi" : "RaporDapodikKabupaten")+"/" + option.kode_wilayah.trim()} onClick={()=>this.dataRaporWilayah(option.kode_wilayah.trim())}><b>{option.nama}</b></a><br/>
...
export default (connect(mapStateToProps, mapDispatchToProps)(RaporDapodikProvinsi));
