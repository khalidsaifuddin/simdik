...
class RaporDapodikPD extends Component {
    state = {
        error: null,
        loading: true,
        routeParams:{
    ...
    {
        return (
            <Page name="RaporDapodikPD" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Rapor {localStorage.getItem('kode_aplikasi') === 'RAPORDAPODIK' ? 'Dapodik' : 'Kualitas Data'} PD</NavTitle>
                    <NavTitleLarge>
                        Rapor {localStorage.getItem('kode_aplikasi') === 'RAPORDAPODIK' ? 'Dapodik' : 'Kualitas Data'} PD
                    </NavTitleLarge>
                </Navbar>
                <SelectSemester/>
                {this.state.loading ? 
                            ...
                            <Block strong style={{marginBottom:'0px'}} className="hilangDiMobile">
                                <Row>
                                    ...
                                    <Col width="100" tabletWidth="70">
                                        <Row>
                                            <Col width="15" tabletWidth="15" style={{fontWeight:'bold', textAlign: 'center'}}>
                                                Tingkat Kelas
                                            </Col>
                                            <Col width="15" tabletWidth="15" style={{fontWeight:'bold', textAlign: 'center'}}>
                                                Nama Rombel
                            ...
                            {this.props.dummy_rows.rows.map((result)=>{
                                return (
                                    <Row style={{borderBottom:'1px solid #ccc', marginTop:'2px', border:'1px solid #ccc', padding:'8px', borderRadius: '4px'}}>
                                        ...
                                        <Col width="100" tabletWidth="70">
                                            <Row>
                                                <Col width="15" tabletWidth="15" style={{fontSize:'18px', fontWeight:'bold', textAlign: 'left'}} className="hilangDiMobile skeleton-text skeleton-effect-blink">
                ...
                <Row noGap>
                    <Col width="100" tabletWidth="100">
                        ...
                        <Block>
                            <Segmented raised>
                                <Button tabLink="#tab1" tabLinkActive>Nilai Rapor</Button>
                                <Button tabLink="#tab2" href={"/RaporDapodikPDIndividu/"+this.props.rapor_dapodik_pd.rows[0].sekolah_id}>Indikator Penghitungan</Button>
                            </Segmented>
                        </Block>
                        ...
                        <Block strong style={{marginBottom:'0px', marginTop:'0px'}} className="hilangDiMobile">
                            <Row>
                                    ...
                                    <Col width="100" tabletWidth="70">
                                        <Row>
                                            <Col width="15" tabletWidth="25" style={{fontWeight:'bold', textAlign: 'center'}}>
                                                Tingkat Kelas
                                            </Col>
                                            <Col width="15" tabletWidth="25" style={{fontWeight:'bold', textAlign: 'center'}}>
                                                Nama Rombel
                                            </Col>
                                            <Col width="15" tabletWidth="30" style={{fontWeight:'bold', textAlign: 'right'}}>
                                                Nilai Rapor
                                            </Col>
                        ...
                        {this.props.rapor_dapodik_pd.rows.map((option)=>{
                            ...
                            return (
                                <Row key={option.sekolah_id} style={{borderBottom:'1px solid #ccc', marginTop:'2px', border:'1px solid #ccc', padding:'8px', borderRadius: '4px'}}>
                                    ...
                                    <Col width="20" tabletWidth="20" style={{textAlign: 'right', paddingLeft: '16px'}} className="hilangDiDesktop">
                                    ...
                                    <Col width="100" tabletWidth="70">
                                        <Row>
                                            ...
                                            <Col width="20" tabletWidth="20" style={{textAlign: 'right', paddingLeft:'8px',}} className="hilangDiMobile">
...
export default (connect(mapStateToProps, mapDispatchToProps)(RaporDapodikPD));