...
class SekolahWaktuPenyelenggaraanSp extends Component {
    state = {
        error: null,
        loading: true,
        routeParams: {
        ...
        this.setState({
            ...
            this.props.getWilayah(this.state.routeParams).then((result)=>{
                this.setState({
                    ...
                    this.props.getRekapSekolahWaktuPenyelenggaraanSp(this.state.routeParams).then((result)=>{
                        this.setState({
                            ...this.state,
                            loading: false
                        });
                    ...
                    this.props.setIsiKanan((
                        ...
                        <List>  
                            <ListItem style={{cursor:'pointer'}} title="Unduh Excel" onClick={()=>{window.open(
                                    localStorage.getItem('api_base')+"/api/Sekolah/getRekapSekolahWaktuPenyelenggaraanSpExcel"
                                    +"?semester_id="+localStorage.getItem('semester_id_aplikasi')
                                    +"&tahun_ajaran_id="+localStorage.getItem('semester_id_aplikasi').substring(0,4)
    ...
    bukaPengaturan = () => {
        // alert('oke');
        this.props.setJudulKanan('Menu Waktu Penyelenggaraan Per Sekolah');
    ...
    {
        return (
            <Page name="SekolahWaktuPenyelenggaraanSp" hideBarsOnScroll>
                ...
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    ...
                    <Subnavbar>
                        <Segmented raised>
                            <Button tabLink="#tab1" href={"/Sekolah/WaktuPenyelenggaraan"}>Per Wilayah</Button>
                ...
                <Navbar sliding={false}>
                    ...
                    <Subnavbar>
                        <Segmented raised>
                            <Button tabLink="#tab1" href={(parseInt(this.state.routeParams.id_level_wilayah) === 1 ? "/Sekolah/WaktuPenyelenggaraan/1/"+this.state.routeParams.kode_wilayah : "/Sekolah/WaktuPenyelenggaraan/2/"+this.state.routeParams.kode_wilayah)}>Per Wilayah</Button>
                            <Button tabLink="#tab2" tabLinkActive>Per Sekolah</Button>
                        </Segmented>
                    </Subnavbar>
                    <NavRight >
                    ...
                    <div className="data-table" style={{overflowY:'hidden'}}>
                        <div className="data-table-footer" style={{display:'block'}}>
                            <div className="data-table-pagination">
                                ...
                                <a onClick={this.klikNext} href="#" className={"link "+((parseInt(this.state.routeParams.start)+20) > parseInt(this.props.rekap_sekolah_waktu_penyelenggaraan_sp.total) ? "disabled" : "" )}>
                                    <i className="icon icon-next color-gray"></i>
                                </a>
                                <span className="data-table-pagination-label">{(this.state.routeParams.start+1)}-{(this.state.routeParams.start)+parseInt(this.state.routeParams.limit)} dari {this.formatAngka(this.props.rekap_sekolah_waktu_penyelenggaraan_sp.total)} sekolah</span>
                            </div>
                        </div>
                        <table>
                            <thead style={{background:'#eeeeee'}}>
                                <tr>
                                    ...
                                    <th className="label-cell" style={{textAlign:'left', color:'#434343', fontSize:'15px'}}>Waktu Penyelenggaraan</th>
                            ...
                            :
                            <>
                            {this.props.rekap_sekolah_waktu_penyelenggaraan_sp.rows.map((option)=>{
                                return(
                                    <tr>
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
      ...
      getRekapSekolahWaktuPenyelenggaraanSp: Actions.getRekapSekolahWaktuPenyelenggaraanSp,
...
function mapStateToProps({ App, PesertaDidik, Gtk, RaporDapodik, RekapSekolah }) {
    ...
    return {
        ...
        rekap_sekolah_waktu_penyelenggaraan_sp: RekapSekolah.rekap_sekolah_waktu_penyelenggaraan_sp
    }
}

export default (connect(mapStateToProps, mapDispatchToProps)(SekolahWaktuPenyelenggaraanSp));