...
class SekolahAkreditasiSp extends Component {
    state = {
        error: null,
        loading: true,
        routeParams: {
        ...
        this.setState({
            ...
            this.props.getWilayah(this.state.routeParams).then((result)=>{
                this.setState({
                    ...
                    this.props.getRekapSekolahAkreditasiSp(this.state.routeParams).then((result)=>{
                        this.setState({
                            ...this.state,
                            loading: false
                        });
                    ...
                    this.props.setIsiKanan((
                        ...
                        <List>  
                            <ListItem style={{cursor:'pointer'}} title="Unduh Excel" onClick={()=>{window.open(
                                    localStorage.getItem('api_base')+"/api/Sekolah/getRekapSekolahAkreditasiSpExcel"
                                    +"?semester_id="+localStorage.getItem('semester_id_aplikasi')
                                    +"&tahun_ajaran_id="+localStorage.getItem('semester_id_aplikasi').substring(0,4)
    ...
    {
        return (
            <Page name="SekolahAkreditasiSp" hideBarsOnScroll>
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
      ...
      getRekapSekolahAkreditasiSp: Actions.getRekapSekolahAkreditasiSp,
...
export default (connect(mapStateToProps, mapDispatchToProps)(SekolahAkreditasiSp));