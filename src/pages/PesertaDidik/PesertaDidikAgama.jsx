...
class PesertaDidikAgama extends Component {
    state = {
        error: null,
        loading: true,
        routeParams: {
        ...
        this.setState({
            ...
            this.props.getWilayah(this.state.routeParams).then((result)=>{
                this.setState({
                    ...
                    this.props.getRekapPesertaDidikAgama(this.state.routeParams).then((result)=>{
                        this.setState({
                            ...this.state,
                            loading: false
                        });
                    ...
                    this.props.setIsiKanan((
                        ...
                        <List>  
                            <ListItem style={{cursor:'pointer'}} title="Unduh Excel" onClick={()=>{window.open(
                                    localStorage.getItem('api_base')+"/api/PesertaDidik/getRekapPesertaDidikAgamaExcel"
                                    +"?semester_id="+localStorage.getItem('semester_id_aplikasi')
                                    +"&tahun_ajaran_id="+localStorage.getItem('semester_id_aplikasi').substring(0,4)
    ...
    bukaPengaturan = () => {
        // alert('oke');
        this.props.setJudulKanan('Menu Agama Peserta Didik');
                ...
                <Block strong style={{
                    ...
                    <div className="data-table" style={{overflowY:'hidden'}}>
                        <table>
                            ...
                            :
                            <>
                            {this.props.rekap_peserta_didik_agama.rows.map((option)=>{
                                return(
...
export default (connect(mapStateToProps, mapDispatchToProps)(PesertaDidikAgama));